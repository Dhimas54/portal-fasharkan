<div class="footer-area footer-padding fix">
                ...
                <div class="row d-flex justify-content-between">
                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-logo">
                                    <a href="index.php"><img src="assets/img/logo/bannernew.png" alt=""></a>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4  col-sm-6">
                        <div class="single-footer-caption mt-60">
                            <div class="footer-tittle">
                                <h4>Subscribe</h4>
                                <p>Kirim email dan dapatkan info terbaru tentang kami</p>
                                <!-- Form -->
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Website by <a href="#" target="_blank">Serda Dhimas_R.M</a>
